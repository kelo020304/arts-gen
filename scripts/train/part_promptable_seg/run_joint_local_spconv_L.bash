...
export OUT_DIR="${OUT_DIR:-/robot/data-lab/jzh/art-gen/ckpt/part-prompt-seg/part-prompt-seg-L-joint-local-spconv-v6}"
...
export JOINT_LOCAL_MODE=post_spconv
...
# Preserve the 0709 overlap partial-label unary weight while disabling its
# probability smoothing terms. The new supervised affinity owns adjacency.
