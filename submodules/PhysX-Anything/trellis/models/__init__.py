...
__attributes = {
    ...
    'ControlledSparseStructureFlowModel': 'sparse_structure_flow',
    'ControlNet': 'sparse_structure_flow',
...
if __name__ == '__main__':
    ...
    from .sparse_structure_flow import SparseStructureFlowModel,ControlledSparseStructureFlowModel,ControlNet
